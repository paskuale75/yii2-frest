...
use paskuale75\frest\bundles\ThemeAsset;
use yii\base\BaseObject;

/**
 * This is the class of Frest Component
 */
class Frest extends BaseObject
{
     ...
     * Classes paths
     */
    const CLASS_HTML = '@vendor/paskuale75/yii2-frest/helpers/Html.php';
     ...
     */
    public static $componentName = 'frest';
